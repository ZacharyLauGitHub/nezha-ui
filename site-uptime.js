/**
 * Site Uptime - 网站运行时长组件
 * 版本: v2.0.0 (Self-Contained)
 * 
 * 功能：
 * - 实时计算网站运行时长
 * - CSS 自动注入，无需手动添加样式
...
/* ========== 玻璃卡片 ========== */
.uptime-glass-card {
    background: transparent linear-gradient(125deg,
...
html.dark .uptime-glass-card {
    background: transparent linear-gradient(135deg,
            rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0.1) 100%);
    backdrop-filter: blur(5px);
    -webkit-backdrop-filter: blur(5px);
