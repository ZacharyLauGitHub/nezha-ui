...
(function () {
    ...
    .bottom-marquee {
      ...
      padding: 0 16px;
      /* 液态玻璃效果 (色散版) */
      background: linear-gradient(135deg, rgba(255,255,255,.2) 0%, rgba(255,255,255,.01) 50%, rgba(255,255,255,.1) 100%);
    ...
    [data-theme="dark"] .bottom-marquee {
      background: linear-gradient(135deg, rgba(0,0,0,.2) 0%, rgba(0,0,0,.01) 50%, rgba(0,0,0,.1) 100%);
      backdrop-filter: blur(8px) saturate(200%) contrast(1.1);
      -webkit-backdrop-filter: blur(8px) saturate(200%) contrast(1.1);
